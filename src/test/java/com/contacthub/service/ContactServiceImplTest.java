...
class ContactServiceImplTest {
	...
	void create_savesContact_returnsResponse() {
		ContactRequest request = new ContactRequest("Jane", "Doe", "jane@example.com", "0412345678", "123 Main St",
				"Sydney", "Australia");
	...
	void fetch_throwsException_whenEmailNotFound() {
		...
		IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> contactService.fetch(email));
